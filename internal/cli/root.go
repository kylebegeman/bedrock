...
func newRoot(stdout, stderr io.Writer) *cobra.Command {
	...
	root.AddCommand(newVersion(a), newDoctor(a), newHost(a), newUpgrade(a), newDeploy(a), newRollback(a), newPs(a), newLogs(a), newExec(a), newGC(a), newSecret(a), newRun(a), newJobs(a), newPsql(a), newHistory(a), newKernel(a), newDaemon(a))
	return root
}
